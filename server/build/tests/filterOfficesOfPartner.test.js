...
test("Filter Offices with 10 KM Test For a 'Gallus Consulting' partner", function () {
    ...
    var results = filterOffice.getOffices();
...
test("Filter Offices with 200 KM Test For a 'Gallus Consulting' partner", function () {
    //set filter of offices
    var filterOffice = new offices_1.default();
    filterOffice.addFilter({
        key: "distance",
...
test("Filter Offices with 50 KM Test For a 'Balance at Work' partner", function () {
    //set filter of offices
    var filterOffice = new offices_1.default();
    filterOffice.addFilter({
        key: "distance",
